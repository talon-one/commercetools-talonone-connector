...
module.exports = {
  ...
  createCartWithItemsEvent: require('./commercetools/create-cart-with-items-event.json'),
  ...
  updateCartWithPerItemDiscountActions: require('./actions/update-cart-with-per-item-discount-actions.json'),
  ...
  updateCustomerSessionWithPerItemDiscountResponse: require('./talonone/update-customer-session-with-per-item-discount-response.json'),
